...
export default function ProductDetail({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-10 p-8 rounded-2xl bg-[linear-gradient(to_bottom_right,rgba(26,20,74,0.7),rgba(11,8,42,0.8))] border border-[rgba(201,162,39,0.15)]">
      {/* Images */}
      <div className="flex flex-col gap-3 md:w-96 shrink-0">
        {/* Main image */}
        <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-[rgba(201,162,39,0.2)]">
          <Image
            src={selectedImage}
            alt={product.name}
            fill
      ...
      <div className="flex flex-col gap-5 flex-1">
        <div>
          ...
          <p className="text-2xl font-semibold font-sarabun text-gold">
        ...
        {/* Description */}
        <div>
          <p className="text-xs text-white/40 font-sarabun mb-1.5">คำอธิบาย</p>
        ...
        {benefits.length > 0 && (
          <div>
            <p className="text-xs text-white/40 font-sarabun mb-1.5">สรรพคุณ</p>
        ...
        <div className="flex items-center gap-3 mt-2">
          {/* Quantity */}
          <div className="flex items-center rounded-lg overflow-hidden border border-[rgba(201,162,39,0.2)]">
            <button
            ...
            <span className="w-10 text-center text-lg font-sarabun text-cream">
              {quantity}
            </span>
          ...
          <Button
            ...
            className="flex-1 py-2.5 rounded-xl border-0 font-sarabun text-lg font-semibold text-navy transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:translate-y-0 bg-[linear-gradient(135deg,#c9a227_0%,#7a5c0a_100%)] shadow-[0_4px_20px_rgba(201,162,39,0.35)]"
          >
            {isPending ? (
